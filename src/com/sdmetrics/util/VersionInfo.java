...
public class VersionInfo {
	...
	public static final String PROPERTIES_FILE = ".SDMetrics2.3.props";
	/** The previous files that stored the application properties. */
	static final String[] oldVersions = { ".SDMetricsDemo2.3.props",
	...
	public static final String VERSION_NUMBER = "V2.35";
	/** Program name+version. */
	public static final String VERSION = "SDMetrics " + VERSION_NUMBER;
	/** Copyright string, using unicode characters. */
	public static final String COPYRIGHT = "\u00a9 2002-2018 by J\u00FCrgen W\u00FCst";
	/** Copyright string, using only ASCII characters. */
	public static final String COPYRIGHTASCII = "(c) 2002-2018 by Juergen Wuest";
}
